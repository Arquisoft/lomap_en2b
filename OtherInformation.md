...
The workflow for this is in [lomap_en2b.yml](.github/workflow/lomap_en2b.yml). In this file you can see that there are two jobs, one for the restapi, one for the webapp. Jobs are executed in paralel so this will speed up our build.
