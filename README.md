...
If you want to execute the project you will need [git](https://git-scm.com/downloads), [Node.js and npm](https://www.npmjs.com/get-npm) and [Docker](https://docs.docker.com/get-docker/). Make sure the three of them are installed in your system. Download the project with `git clone https://github.com/arquisoft/lomap_en2b`. The fastest way to launch everything is with docker:
```bash
...
services:
  restapi:
    image: ghcr.io/arquisoft/lomap_en2b/restapi:latest
    ports:
      - "5000:5000"
  webapp:
