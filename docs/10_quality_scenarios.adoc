...
.2+| Code |  _Maintainability_  | High | The code written must be maintainable, and must be easy to work with it.
| _Efficiency_  | High | The code must be as efficient as possible, without discarding security (see next row)
