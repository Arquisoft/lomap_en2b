...
|===
|*Inrupt*
|Inrupt is a provider of pods, It could happen that it was another provider of SOLID architecture. What's important is that the user has a pod able to connevt to the API.
